	...
	public static void main(String[] args) {
		try {
			...
			System.out.printf("The team:%n%s. %n"
					...
					+ "Technical Support: %s.%n%n",A.getLeadBy(), A.getName(), B.getName(), C.getName(),D.getName());
*/
			...
			A.writeDataToFile();
			//alignmentScore() return method is immutable, thus, it's needed to be set again
			...
			//A.getRepository();
			//Repository rep = X.getRepository();// this Repository cannot be set in main method
